	...
	AUI().use('aui-replacetext', function(A) {
		...
		var onSuggestedWordSelect = function(event) {
			...
			if (text == Language.get('ignore-all')) {
				...
				closeSuggestBox(instance.suggestBox);
